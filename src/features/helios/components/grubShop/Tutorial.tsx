  ...
  return (
    ...
    >
      ...
      <div className="space-y-3 text-sm px-1 mb-3">
        <p>
          {
            "Here you can take any of that delicious food you cooked and sell it for SFL."
          }
        </p>
        <p className="mb-2">
          {
            "The menu changes often so make sure you check in to see what the best deals are."
          }
        </p>
      </div>
